...
const pages = [
  { title: "Meals", route: "meals" },
  { title: "Coctails", route: "coctails" },
];
const settings = ["Profile", "Account", "Dashboard", "Logout"];

function ResponsiveAppBar({setMode, mode}) {
    ...
    <AppBar sx={{ position: "sticky", width: "100%" }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <FormGroup>
            <FormControlLabel
              control={<Switch color="default" onChange={ e=> setMode(mode === "light" ? "dark" : "light" ) }/>}
              label="Dark" 
            />
          </FormGroup>
          <Box sx={{ flexGrow: 0 }}>
